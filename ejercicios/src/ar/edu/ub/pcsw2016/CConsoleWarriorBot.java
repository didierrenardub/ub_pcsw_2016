...
public class CConsoleWarriorBot extends CConsoleWarrior
{
    ...
    public WARRIOR_ABILITY ability()
    {
        return m_ability;
    }

    public WARRIOR_ACTION action(ArrayList<WARRIOR_ACTION> opponentMoves)
    {
    ...
    private WARRIOR_ABILITY m_ability = WARRIOR_ABILITY.values()[new Random().nextInt(WARRIOR_ABILITY.values().length)];
}
